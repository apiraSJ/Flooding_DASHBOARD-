...
└── Flood-detection/
    ...
    └── media/                  ← ไฟล์ตัวอย่างภาพ/วิดีโอสำหรับทดสอบ
```

---

## 💡 เกร็ดความรู้: ทำไมต้องมี 2 environment คือ base กับ geoai?
...
ถ่าย screenshot ข้อความ error เต็มๆ (ทั้งหน้าต่าง terminal) แล้วสอบถามได้เลยครับ ยิ่งเห็น error ชัดเจนเท่าไหร่ ยิ่งช่วยหาสาเหตุได้เร็วเท่านั้น
